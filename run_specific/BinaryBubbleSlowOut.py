...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  8 09:25:24 2020
...
# Run locally
hoomdPath = "${hoomd_path}"#'/Users/nicklauersdorf/hoomd-blue/build'
...
xF = ${xf}/100#0.5                    # fraction of each type
...
# Some parameters:
pef = ${pef}            # fast activity
pes = ${pes}            # slow activity
...
phig = analyticalPhiGas(pes)              # area fraction of gas phase
phig = phig/100.
