...
if [ $vid == "y" ]; then
    if [ $method == "activity-blank" ]; then
        if [ $os == "mac" ]; then
            pic_path="${outpath}_pic_files/part_activity_blank_pa${pa2}_pb${pb}_xa${xa2}_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}"
            vid_path="${outpath}_vid_files/part_activity_blank_pa${pa2}_pb${pb}_xa${xa2}_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}"
