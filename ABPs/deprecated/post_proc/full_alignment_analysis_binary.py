...
with hoomd.open(name=inFile, mode='rb') as t:
    ...
    for p in range(start, end):     
        ...
        for ix in range(0, NBins):
                for iy in range(0, NBins):
                    ...
                    if align_avg_num[ix][iy]!=0:
                        ...
                        align_norm_xA[ix][iy] = align_avg_xA[ix][iy] / (align_avg_xA[ix][iy]**2 + align_avg_yA[ix][iy]**2)**0.5
                        align_norm_yA[ix][iy] = align_avg_yA[ix][iy] / (align_avg_xA[ix][iy]**2 + align_avg_yA[ix][iy]**2)**0.5
                        
                        align_norm_xB[ix][iy] = align_avg_xB[ix][iy] / (align_avg_xB[ix][iy]**2 + align_avg_yB[ix][iy]**2)**0.5
                        align_norm_yB[ix][iy] = align_avg_yB[ix][iy] / (align_avg_xB[ix][iy]**2 + align_avg_yB[ix][iy]**2)**0.5
                    #Otherwise, set each array value to zero
                        ...
                        align_norm_xA[ix][iy] = 0
                        align_norm_yA[ix][iy] = 0
                        
                        align_norm_xB[ix][iy] = 0
                        align_norm_yB[ix][iy] = 0
        ...
        for m in range(0, len(bub_id_arr)):
            ...
            if if_bub_id_arr[m]==1:
                ...
                if len(edge_parts)>0:
                    ...
                    print(x_com_bub)
                    print(y_com_bub)
                    print(np.min(pos[edge_parts,1]))
                    print(np.max(pos[edge_parts,1]))
                    print(h_box)
        ...
        im = plt.contourf(pos_box_x, pos_box_y, align_mag, level_boundaries, vmin=min_n, vmax=max_n, cmap='OrRd_r', extend='both')
        if len(int_vert_x)>0:
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        ...
        clb.ax.set_title(r'$\alpha$', fontsize=16)
        ...
        plt.tight_layout()
        plt.savefig(outPath + 'align_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(min_n, max_n, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, align_magA, level_boundaries, vmin=min_n, vmax=max_n, cmap='OrRd_r', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\alpha_\mathrm{A}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_norm_xA, align_norm_yA, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'alignA_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(min_n, max_n, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, align_magB, level_boundaries, vmin=min_n, vmax=max_n, cmap='OrRd_r', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\alpha_\mathrm{B}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_norm_xB, align_norm_yB, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'alignB_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        im = plt.contourf(pos_box_x, pos_box_y, align_magB, level_boundaries, vmin=-max_n, vmax=max_n, cmap='OrRd_r', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'alignDif_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        im = plt.contourf(pos_box_x, pos_box_y, symlog_arr(div_align), level_boundaries, vmin=div_min, vmax=div_max, cmap='seismic', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\nabla \cdot \mathbf{\alpha}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_norm_x, align_norm_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'divergence_align_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(div_min, div_max, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, symlog_arr(div_alignA), level_boundaries, vmin=div_min, vmax=div_max, cmap='seismic', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\nabla \cdot \mathbf{\alpha_\mathrm{A}}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_norm_x, align_norm_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'divergence_alignA_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(div_min, div_max, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, symlog_arr(div_alignB), level_boundaries, vmin=div_min, vmax=div_max, cmap='seismic', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\nabla \cdot \mathbf{\alpha_\mathrm{B}}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_norm_x, align_norm_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'divergence_alignB_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(div_min, div_max, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, symlog_arr(div_alignDif), level_boundaries, vmin=div_min, vmax=div_max, cmap='seismic', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\nabla \cdot (\mathbf{\alpha_\mathrm{B}}-\mathbf{\alpha_\mathrm{A}})$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_norm_x, align_norm_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'divergence_alignDif_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        im = plt.contourf(pos_box_x, pos_box_y, symlog_arr(curl_align), level_boundaries, vmin=curl_min, vmax=curl_max, cmap='seismic', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\nabla \times \mathbf{\alpha}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_norm_x, align_norm_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'curl_align_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        ax = fig.add_subplot(111)
        level_boundaries = np.linspace(curl_min, curl_max, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, symlog_arr(curl_alignA), level_boundaries, vmin=curl_min, vmax=curl_max, cmap='seismic', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\nabla \times \mathbf{\alpha_\mathrm{A}}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_norm_x, align_norm_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'curl_alignA_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        ax = fig.add_subplot(111)
        level_boundaries = np.linspace(curl_min, curl_max, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, symlog_arr(curl_alignB), level_boundaries, vmin=curl_min, vmax=curl_max, cmap='seismic', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\nabla \times \mathbf{\alpha_\mathrm{B}}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_norm_x, align_norm_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'curl_alignB_' + out + pad + ".png", dpi=150)
        plt.close()
            
        fig = plt.figure(figsize=(7,6))
        ax = fig.add_subplot(111)
        level_boundaries = np.linspace(curl_min, curl_max, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, symlog_arr(curl_alignDif), level_boundaries, vmin=curl_min, vmax=curl_max, cmap='seismic', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\nabla \times (\mathbf{\alpha_\mathrm{B}}-\mathbf{\alpha_\mathrm{A}})$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_norm_x, align_norm_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'curl_alignDif_' + out + pad + ".png", dpi=150)
        plt.close()
