...
python3 $script_path/full_velocity_analysis_binary.py $fname $pa $pb $xa $ep $phi $dtau $bin $step $hoomd_path $txt_path $pic_path
...
#Start
  ...
  ffmpeg -start_number 1 -framerate 10 -i "$pic_path"velocity_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"velocity_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"velocity_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 1 -framerate 10 -i "$pic_path"velocityB_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"velocityB_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"velocityB_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 1 -framerate 10 -i "$pic_path"velocityA_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"velocityA_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

 rm -rf "$pic_path"velocityA_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 1 -framerate 10 -i "$pic_path"velocityDif_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"velocityDif_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"velocityDif_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
  
  ffmpeg -start_number 1 -framerate 10 -i "$pic_path"divergence_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"divergence_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"divergence_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 1 -framerate 10 -i "$pic_path"curl_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"curl_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"curl_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 1 -framerate 10 -i "$pic_path"divergenceA_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"divergenceA_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"divergenceA_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 1 -framerate 10 -i "$pic_path"curlA_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"curlA_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"curlA_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 1 -framerate 10 -i "$pic_path"divergenceB_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"divergenceB_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"divergenceB_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 1 -framerate 10 -i "$pic_path"curlB_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"curlB_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"curlB_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 1 -framerate 10 -i "$pic_path"divergenceDif_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"divergenceDif_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4
 
  rm -rf "$pic_path"divergenceDif_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 1 -framerate 10 -i "$pic_path"curlDif_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"curlDif_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4
  
  rm -rf "$pic_path"curlDif_pa${pa}_pb${pb}_xa${xa}_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
