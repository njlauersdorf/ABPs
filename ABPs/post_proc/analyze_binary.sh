...
if [ "$method" = "interface_pressure_com" ]; then
    ...
    ffmpeg -start_number 1 -framerate 10 -i "$pic_path"velocity_map_pa${pa2}_pb${pb}_xa${xa2}_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
     -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
    ...
    ffmpeg -start_number 1 -framerate 10 -i "$pic_path"velocity_A_map_pa${pa2}_pb${pb}_xa${xa2}_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
     -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
    ...
    ffmpeg -start_number 1 -framerate 10 -i "$pic_path"velocity_B_map_pa${pa2}_pb${pb}_xa${xa2}_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
     -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
    ...
    ffmpeg -start_number 1 -framerate 10 -i "$pic_path"div_map_pa${pa2}_pb${pb}_xa${xa2}_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
     -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
    ...
    ffmpeg -start_number 1 -framerate 10 -i "$pic_path"div_A_map_pa${pa2}_pb${pb}_xa${xa2}_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
     -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
    ...
    ffmpeg -start_number 1 -framerate 10 -i "$pic_path"div_B_map_pa${pa2}_pb${pb}_xa${xa2}_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
     -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
    ...
    ffmpeg -start_number 1 -framerate 10 -i "$pic_path"curl_map_pa${pa2}_pb${pb}_xa${xa2}_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
     -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
    ...
    ffmpeg -start_number 1 -framerate 10 -i "$pic_path"curl_A_map_pa${pa2}_pb${pb}_xa${xa2}_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
     -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
    ...
    ffmpeg -start_number 1 -framerate 10 -i "$pic_path"curl_B_map_pa${pa2}_pb${pb}_xa${xa2}_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
     -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
    ...
    ffmpeg -start_number 0 -framerate 10 -i "$pic_path"fast_frac_pa${pa2}_pb${pb}_xa${xa2}_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
     -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
    ...
    ffmpeg -start_number 0 -framerate 10 -i "$pic_path"fast_frac_zoom_pa${pa2}_pb${pb}_xa${xa2}_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
     -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
    ...
    ffmpeg -start_number 0 -framerate 10 -i "$pic_path"sim_frame_pa${pa2}_pb${pb}_xa${xa2}_eps${eps}_phi${phi}_pNum${pNum}_frame_%04d.png\
     -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
