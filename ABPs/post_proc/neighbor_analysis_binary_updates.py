...
outTxt_neighbor = 'Neighbor_' + outfile + '.txt'

#.txt file for saving overall phase composition data
g = open(outPath2+outTxt_neighbor, 'w+') # write file headings
g.write('tauB'.center(15) + ' ' +\
                        'sizeBin'.center(15) + ' ' +\
                        'clust_size'.center(15) + ' ' +\
                        'bulk_fast0'.center(15) + ' ' +\
                        'bulk_slow0'.center(15) + ' ' +\
                        'bulk_0'.center(15) + ' ' +\
                        'bulk_fast1'.center(15) + ' ' +\
                        'bulk_slow1'.center(15) + ' ' +\
                        'bulk_1'.center(15) + ' ' +\
                        'bulk_fast2'.center(15) + ' ' +\
                        'bulk_slow2'.center(15) + ' ' +\
                        'bulk_2'.center(15) + ' ' +\
                        'bulk_fast3'.center(15) + ' ' +\
                        'bulk_slow3'.center(15) + ' ' +\
                        'bulk_3'.center(15) + ' ' +\
                        'bulk_fast4'.center(15) + ' ' +\
                        'bulk_slow4'.center(15) + ' ' +\
                        'bulk_4'.center(15) + ' ' +\
                        'bulk_fast5'.center(15) + ' ' +\
                        'bulk_slow5'.center(15) + ' ' +\
                        'bulk_5'.center(15) + ' ' +\
                        'bulk_fast6'.center(15) + ' ' +\
                        'bulk_slow6'.center(15) + ' ' +\
                        'bulk_6'.center(15) + ' ' +\
                        'int_fast0'.center(15) + ' ' +\
                        'int_slow0'.center(15) + ' ' +\
                        'int_0'.center(15) + ' ' +\
