...
ffmpeg -start_number 0 -framerate 10 -i "$pic_path"num_dens_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"num_dens_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"num_dens_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"num_densB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"num_densB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"num_densB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"num_densA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"num_densA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"num_densA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"num_densDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"num_densDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"num_densDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"press_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"press_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"press_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"pressB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"pressB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"pressB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"pressA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"pressA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"pressA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"pressDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"pressDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"pressDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*




  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"grad_num_dens_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"grad_num_dens_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"grad_num_dens_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"grad_num_densB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"grad_num_densB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"grad_num_densB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"grad_num_densA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"grad_num_densA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"grad_num_densA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"grad_num_densDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"grad_num_densDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"grad_num_densDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
 
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"grad_press_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"grad_press_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"grad_press_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"grad_pressB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"grad_pressB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"grad_pressB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"grad_pressA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"grad_pressA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"grad_pressA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"grad_pressDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"grad_pressDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"grad_pressDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
