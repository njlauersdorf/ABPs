...
ffmpeg -start_number 0 -framerate 10 -i "$pic_path"num_dens_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"num_dens_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}.mp4

  rm -rf "$pic_path"num_dens_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_*

  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"num_densB_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"num_densB_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}.mp4

  rm -rf "$pic_path"num_densB_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_*
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"num_densA_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"num_densA_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}.mp4

  rm -rf "$pic_path"num_densA_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_*
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"num_densDif_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"num_densDif_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}.mp4

  rm -rf "$pic_path"num_densDif_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_*

  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"fa_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"fa_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}.mp4

  rm -rf "$pic_path"fa_pa${pa2}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum${pNum}_bin${bin}_time${step}_frame_*
