...
#Start
  ...
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"interface_acc_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"align_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"interface_acc_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"align_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"align_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"align_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"alignB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"alignB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"alignB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"alignA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"alignA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"alignA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"alignDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"alignDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"alignDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

 
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"divergence_align_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"divergence_align_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"divergence_align_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"divergence_alignB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"divergence_alignB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"divergence_alignB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"divergence_alignA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"divergence_alignA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"divergence_alignA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"divergence_alignDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"divergence_alignDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"divergence_alignDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*


  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"curl_align_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"curl_align_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"curl_align_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"curl_alignB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"curl_alignB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4

  rm -rf "$pic_path"curl_alignB_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
 
  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"curl_alignA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"curl_alignA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4
 
  rm -rf "$pic_path"curl_alignA_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*

  ffmpeg -start_number 0 -framerate 10 -i "$pic_path"curl_alignDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 "$vid_path"curl_alignADifpa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1.mp4
  
  rm -rf "$pic_path"curl_alignDif_pa${pa}_pb${pb}_xa50_eps${eps}_phi${phi}_pNum100000_bin6_time1_frame_*
