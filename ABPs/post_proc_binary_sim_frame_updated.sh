...
if [ $answer2 == "y" ]; then
    ...
    do
        ...
        $submit $script_path/analyze_binary_sim_frame_updated.sh $hoomd_path $txt_path $pic_path $vid_path $script_path $file
    ...
    do
        ...
        $submit $script_path/analyze_binary_xa50_sim_frame_updated.sh $hoomd_path $txt_path $pic_path $vid_path $script_path $file
