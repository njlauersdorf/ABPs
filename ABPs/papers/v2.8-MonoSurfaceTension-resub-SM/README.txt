...
The zip file contains:
 ...
 - rsc-articletemplate-softmatter.tex (the template with example text)

 - rsc-articletemplate-softmatter.pdf (an example of the template output PDF)

 - rsc.bib (example bibliography)

 - example1.pdf and example2.pdf (example figures)

 - head_foot (folder containing header and footer images)

 - rsc.bst (the RSC bibliography style file).


The following files need to be in the same folder as rsc-articletemplate-softmatter.tex for the example template to compile correctly:
