...
if [ $answer2 == "y" ]; then
    ...
    do
        ...
        $submit $script_path/analyze_binary_velocity_updated.sh $hoomd_path $txt_path $pic_path $vid_path $script_path $file $bin_size $time_step
    ...
    do
        ...
        $submit $script_path/analyze_binary_xa50_velocity_updated.sh $hoomd_path $txt_path $pic_path $vid_path $script_path $file $bin_size $time_step
