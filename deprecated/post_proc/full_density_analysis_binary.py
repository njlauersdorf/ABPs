...
with hoomd.open(name=inFile, mode='rb') as t:
    ...
    for p in range(start, end):     
        ...
        for ix in range(0, NBins):
                for iy in range(0, NBins):
                    ...
                    if align_avg_num[ix][iy]!=0:
                        ...
                        align_norm_x[ix][iy] = align_avg_x[ix][iy] / (align_avg_x[ix][iy]**2 + align_avg_y[ix][iy]**2)**0.5
                        align_norm_y[ix][iy] = align_avg_y[ix][iy] / (align_avg_x[ix][iy]**2 + align_avg_y[ix][iy]**2)**0.5
                    #Otherwise, set each array value to zero
                        ...
                        align_norm_x[ix][iy] = 0
                        align_norm_y[ix][iy] = 0
        ...
        press_intA = [[0 for b in range(NBins)] for a in range(NBins)]
        press_intB = [[0 for b in range(NBins)] for a in range(NBins)]
        press_intDif = [[0 for b in range(NBins)] for a in range(NBins)]
        ...
        for ix in range(0, len(occParts)):
                for iy in range(0, len(occParts)):
                    ...
                    press_intA[ix][iy] = num_dens3A[ix][iy]*(align_avg_xA[ix][iy]**2+align_avg_yA[ix][iy]**2)**0.5
                    press_intB[ix][iy] = num_dens3B[ix][iy]*(align_avg_xB[ix][iy]**2+align_avg_yB[ix][iy]**2)**0.5
                    press_intDif[ix][iy] = press_intB[ix][iy]-press_intA[ix][iy]
        ...
        numdensgradDif = np.gradient(num_densDif)
        #Gradient of pressure
        pgrad = np.gradient(press_int) 
        pgradA = np.gradient(press_intA) 
        pgradB = np.gradient(press_intB) 
        pgradDif = np.gradient(press_intDif) 
        ...
        numdensegrad2Dif = np.sqrt(numdensgradDif[0]**2 + numdensgradDif[1]**2)
        ...
        im = plt.contourf(pos_box_x, pos_box_y, num_dens3, level_boundaries, vmin=min_n, vmax=max_n, cmap='OrRd', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        ...
        clb.ax.set_title(r'$\mathrm{n}$', fontsize=16)
        ...
        plt.tight_layout()
        plt.savefig(outPath + 'num_dens_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(min_n, max_n, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, num_dens3A, level_boundaries, vmin=min_n, vmax=max_n, cmap='OrRd', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\mathrm{n}_\mathrm{A}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_avg_x, align_avg_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'num_densA_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(min_n, max_n, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, num_dens3B, level_boundaries, vmin=min_n, vmax=max_n, cmap='OrRd', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\mathrm{n}_\mathrm{B}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_avg_x, align_avg_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'num_densB_' + out + pad + ".png", dpi=150)
        plt.close()
        
        fig = plt.figure(figsize=(7,6))
        ax = fig.add_subplot(111)
        levels_text=40
        level_boundaries = np.linspace(-max_n, max_n, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, num_densDif, level_boundaries, vmin=-max_n, vmax=max_n, cmap='seismic', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
        norm= matplotlib.colors.Normalize(vmin=-max_n, vmax=max_n)

        sm = plt.cm.ScalarMappable(norm=norm, cmap = im.cmap)
        sm.set_array([])
        tick_lev = np.arange(-max_n, max_n+max_n/5, (max_n)/5)
        clb = fig.colorbar(sm, ticks=tick_lev, boundaries=level_boundaries,
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\mathrm{n}_\mathrm{B}-\mathrm{n}_\mathrm{A}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_avg_x, align_avg_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'num_densDif_' + out + pad + ".png", dpi=150)
        plt.close()
        
        fig = plt.figure(figsize=(7,6))
        ax = fig.add_subplot(111)
        levels_text=40
        level_boundaries = np.linspace(min_press, max_press, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, press_int, level_boundaries, vmin=min_press, vmax=max_press, cmap='OrRd', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
        norm= matplotlib.colors.Normalize(vmin=min_press, vmax=max_press)

        sm = plt.cm.ScalarMappable(norm=norm, cmap = im.cmap)
        sm.set_array([])
        tick_lev = np.arange(min_press, max_press+max_press/10, (max_press-min_press)/10)
        clb = fig.colorbar(sm, ticks=tick_lev, boundaries=level_boundaries,
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\Pi$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_avg_x, align_avg_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'press_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(min_press, max_press, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, press_intA, level_boundaries, vmin=min_press, vmax=max_press, cmap='OrRd', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\Pi_\mathrm{A}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_avg_x, align_avg_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'pressA_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(min_press, max_press, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, press_intB, level_boundaries, vmin=min_press, vmax=max_press, cmap='OrRd', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\Pi_\mathrm{B}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_avg_x, align_avg_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'pressB_' + out + pad + ".png", dpi=150)
        plt.close()
        
        fig = plt.figure(figsize=(7,6))
        ax = fig.add_subplot(111)
        levels_text=40
        level_boundaries = np.linspace(-max_press, max_press, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, press_intDif, level_boundaries, vmin=-max_press, vmax=max_press, cmap='seismic', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
        norm= matplotlib.colors.Normalize(vmin=-max_press, vmax=max_press)

        sm = plt.cm.ScalarMappable(norm=norm, cmap = im.cmap)
        sm.set_array([])
        tick_lev = np.arange(-max_press, max_press+max_press/5, (max_press)/5)
        clb = fig.colorbar(sm, ticks=tick_lev, boundaries=level_boundaries,
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\Pi_\mathrm{B}-\Pi_\mathrm{A}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_avg_x, align_avg_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'pressDif_' + out + pad + ".png", dpi=150)
        plt.close()
        
        fig = plt.figure(figsize=(7,6))
        ax = fig.add_subplot(111)
        levels_text=40
        level_boundaries = np.linspace(min_n2, max_n2, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, numdensegrad2, level_boundaries, vmin=min_n2, vmax=max_n2, cmap='OrRd', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
        norm= matplotlib.colors.Normalize(vmin=min_n2, vmax=max_n2)

        sm = plt.cm.ScalarMappable(norm=norm, cmap = im.cmap)
        sm.set_array([])
        tick_lev = np.arange(min_n2, max_n2+max_n2/10, (max_n2-min_n2)/10)
        clb = fig.colorbar(sm, ticks=tick_lev, boundaries=level_boundaries,
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\nabla \mathrm{n}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_avg_x, align_avg_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'grad_num_dens_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(min_n2, max_n2, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, numdensegrad2A, level_boundaries, vmin=min_n2, vmax=max_n2, cmap='OrRd', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\nabla \mathrm{n}_\mathrm{A}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_avg_x, align_avg_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'grad_num_densA_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(min_n2, max_n2, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, numdensegrad2B, level_boundaries, vmin=min_n2, vmax=max_n2, cmap='OrRd', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\nabla \mathrm{n}_\mathrm{B}$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_avg_x, align_avg_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'grad_num_densB_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(min_n2, max_n2, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, numdensegrad2Dif, level_boundaries, vmin=min_n2, vmax=max_n2, cmap='OrRd', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\nabla (\mathrm{n}_\mathrm{B}-\mathrm{n}_\mathrm{A})$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_avg_x, align_avg_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'grad_num_densDif_' + out + pad + ".png", dpi=150)
        plt.close()
        
        fig = plt.figure(figsize=(7,6))
        ax = fig.add_subplot(111)
        levels_text=40
        level_boundaries = np.linspace(min_press_grad, max_press_grad, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, fulgrad, level_boundaries, vmin=min_press_grad, vmax=max_press_grad, cmap='OrRd', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
        norm= matplotlib.colors.Normalize(vmin=min_press_grad, vmax=max_press_grad)

        sm = plt.cm.ScalarMappable(norm=norm, cmap = im.cmap)
        sm.set_array([])
        tick_lev = np.arange(min_press_grad, max_press_grad+max_press_grad/10, (max_press_grad-min_press_grad)/10)
        clb = fig.colorbar(sm, ticks=tick_lev, boundaries=level_boundaries,
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\nabla \Pi$', fontsize=16)
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'grad_press_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(min_press_grad, max_press_grad, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, fulgradA, level_boundaries, vmin=min_press_grad, vmax=max_press_grad, cmap='OrRd', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'grad_pressA_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(min_press_grad, max_press_grad, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, fulgradB, level_boundaries, vmin=min_press_grad, vmax=max_press_grad, cmap='OrRd', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'grad_pressB_' + out + pad + ".png", dpi=150)
        plt.close()
        ...
        levels_text=40
        level_boundaries = np.linspace(min_press_grad, max_press_grad, levels_text + 1)
        im = plt.contourf(pos_box_x, pos_box_y, fulgradDif, level_boundaries, vmin=min_press_grad, vmax=max_press_grad, cmap='OrRd', extend='both')
        if len(int_vert_x)>0:
            plt.scatter(int_vert_x, int_vert_y, s=8, color=new_green)
        if len(ext_vert_x)>0:
            plt.scatter(ext_vert_x, ext_vert_y, s=8, color=new_green)
...
values=(level_boundaries[:-1] + level_boundaries[1:]) / 2)
        clb.ax.tick_params(labelsize=16)
        clb.ax.set_title(r'$\nabla (\Pi_\mathrm{B}-\Pi_\mathrm{A})$', fontsize=16)
        plt.quiver(pos_box_x, pos_box_y, align_avg_x, align_avg_y, color='black')
        ...
        plt.title(r'$\mathrm{Pe}_\mathrm{A}$' + ' = ' + str(int(peA)) + ', ' + r'$\mathrm{Pe}_\mathrm{B}$' + ' = ' + str(int(peB)) + ', ' + r'$\chi_\mathrm{A}$' + ' = ' + str(parFrac/100) + ', ' + r'$\phi$' + ' = ' + str(phi) + ', ' + r'$\epsilon$' + ' = ' + r'$10^{{{}}}$'.format(int(np.log10(eps))), fontsize=14)
        plt.tight_layout()
        plt.savefig(outPath + 'grad_pressDif_' + out + pad + ".png", dpi=150)
        plt.close()
