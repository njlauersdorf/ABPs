...
# -*- coding: utf-8 -*-
"""
Created on Wed May 13 10:34:44 2020
...
pe_b = float(sys.argv[2])                     # activity B
...
hoomdPath='/Users/nicklauersdorf/hoomd-blue/build'#nas/longleaf/home/njlauers/hoomd-blue/build/'
gsdPath='/Users/nicklauersdorf/hoomd-blue/build/gsd/'#/Volumes/External/04_01_20_parent/gsd/'#/proj/dklotsalab/users/ABPs/binary_soft/random_init/'
outPath='/Users/nicklauersdorf/hoomd-blue/build/test5/'#/pine/scr/n/j/njlauers/scm_tmpdir/'
# Run locally
...
f = hoomd.open(name=gsdPath+fname, mode='rb')
...
with hoomd.open(name=gsdPath+fname, mode='rb') as t:
    snap = t[0]
...
#for j in range(end - 2, end):
    ...
    plt.show()
    stop
    plt.savefig(outPath + out_file + pad + '.png', dpi=outDPI)
    plt.close()
    stop