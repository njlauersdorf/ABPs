...
python3 $script_path/density_map_image_com.py $fname $pe $pb $xa $ep $phi $tau
...
#ffmpeg -start_number 0 -framerate 10 -i outside_slow_pe${pa}_500_r26_37_rAlign_3.0_frame_%04d.png\
# -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
# outside_slow_pe${pa}_500_r26_37_rAlign_3.02.mp4
...
#ffmpeg -start_number 0 -framerate 10 -i pa${pa}_pb${pb}_xa${xa}_ep${ep}_pNum10000_frame_%04d.png\
# -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
# pa${pa}_pb${pb}_xa${xa}_ep${ep}_pNum10000.mp4
## Videos for seminar
