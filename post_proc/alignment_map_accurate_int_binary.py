       ...
       '_ep' + '{0:.3f}'.format(eps)+'_frame'+str(j)
        ...
        if len(large_clust_ind_all[0])>0:
            ...
            for k in range(1,len(num_sights)):
                        ...
                        if c!=0:
                            ...
                            if d!=0:
                                ...
                                if begin_rad_point<end_rad_point:
                                    ...
                                    int_width_tot += end_rad_point - begin_rad_point
                                    int_width_vals += 1
                                else:
                                    pass
                            else:
                ...
                #int_start
                #int_end 
                int_width = int_width_tot / int_width_vals
                #int_width = 20.0
                #search_range = int_width
                search_range = 2*int_width/3
                search_range2 = int_width/3
