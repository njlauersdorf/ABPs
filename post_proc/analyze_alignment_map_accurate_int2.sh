...
python3 $script_path/alignment_map_accurate_int2.py $fname $pe $pb $xa $ep $phi $tau
...
ffmpeg -start_number 0 -framerate 20 -i /pine/scr/n/j/njlauers/scm_tmpdir/align_video/interface_acc_cluster_pe${pe}_phi${phi}_eps${eps}_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 /pine/scr/n/j/njlauers/scm_tmpdir/complete_videos/interface_acc_pa${pe}_pb${pb}_xa${xa}_phi${phi}_eps${eps}_pNum${pNum}.mp4
