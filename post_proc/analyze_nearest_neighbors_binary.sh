...
#python3 $script_path/Nearest_neighbors.py $fname $pa $pb $xa $ep $phi $tau
...
ffmpeg -start_number 0 -framerate 10 -i /proj/dklotsalab/users/ABPs/binary_soft/random_init/neighbor_video/all_pa${pa}_pb${pb}_xa${xa}_phi${phi}_eps${eps}_pNum${pNum}_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 /proj/dklotsalab/users/ABPs/binary_soft/random_init/neighbor_complete/all_pa${pa}_pb${pb}_xa${xa2}_ep${eps}_phi${phi}_pNum${pNum}.mp4

ffmpeg -start_number 0 -framerate 10 -i /proj/dklotsalab/users/ABPs/binary_soft/random_init/neighbor_video/aa_pa${pa}_pb${pb}_xa${xa}_phi${phi}_eps${eps}_pNum${pNum}_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 /proj/dklotsalab/users/ABPs/binary_soft/random_init/neighbor_complete/aa_pa${pa}_pb${pb}_xa${xa2}_ep${eps}_phi${phi}_pNum${pNum}.mp4

ffmpeg -start_number 0 -framerate 10 -i /proj/dklotsalab/users/ABPs/binary_soft/random_init/neighbor_video/ab_pa${pa}_pb${pb}_xa${xa}_phi${phi}_eps${eps}_pNum${pNum}_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 /proj/dklotsalab/users/ABPs/binary_soft/random_init/neighbor_complete/ab_pa${pa}_pb${pb}_xa${xa2}_ep${eps}_phi${phi}_pNum${pNum}.mp4

ffmpeg -start_number 0 -framerate 10 -i /proj/dklotsalab/users/ABPs/binary_soft/random_init/neighbor_video/ba_pa${pa}_pb${pb}_xa${xa}_phi${phi}_eps${eps}_pNum${pNum}_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 /proj/dklotsalab/users/ABPs/binary_soft/random_init/neighbor_complete/ba_pa${pa}_pb${pb}_xa${xa2}_ep${eps}_phi${phi}_pNum${pNum}.mp4
 
 ffmpeg -start_number 0 -framerate 10 -i /proj/dklotsalab/users/ABPs/binary_soft/random_init/neighbor_video/bb_pa${pa}_pb${pb}_xa${xa}_phi${phi}_eps${eps}_pNum${pNum}_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 /proj/dklotsalab/users/ABPs/binary_soft/random_init/neighbor_complete/bb_pa${pa}_pb${pb}_xa${xa2}_ep${eps}_phi${phi}_pNum${pNum}.mp4
