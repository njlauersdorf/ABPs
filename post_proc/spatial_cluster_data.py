...
outPath='/pine/scr/n/j/njlauers/scm_tmpdir/spatial_cluster_data/'#'Users/nicklauersdorf/hoomd-blue/build/04_01_20_parent/'#'/Volumes/External/04_01_20_parent/gsd/'
outF = inFile[:-4]
...
g.write('tauB'.center(30) + ' ' +\
        'gas_A_parts'.center(30) + ' ' +\
        'gas_B_parts'.center(30) + ' ' +\
        'edge_A_parts'.center(30) + ' ' +\
        'edge_B_parts'.center(30) + ' ' +\
        'bulk_A_parts'.center(30) + ' ' +\
        'bulk_B_parts'.center(30) + ' '+\
        'gas_area'.center(30) + ' ' +\
        'edge_area'.center(30) + ' ' +\
        'bulk_area'.center(30) + '\n')
g.close()
...
g.write('tauB'.center(30) + ' ' +\
        ...
        'gas_A_dens'.center(30) + ' ' +\
        'gas_B_dens'.center(30) + ' ' +\
        'edge_A_dens'.center(30) + ' ' +\
        'edge_B_dens'.center(30) + ' ' +\
        'bulk_A_dens'.center(30) + ' ' +\
        'bulk_B_dens'.center(30) + ' '+\
        'total_A_dens'.center(30) + ' ' +\
        'total_B_dens'.center(30) + '\n')
g.close()
