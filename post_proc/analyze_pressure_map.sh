...
python3 $script_path/pressure_map.py $fname $p3 $pb $xa $ep $phi $tau
...
ffmpeg -start_number 0 -framerate 20 -i /pine/scr/n/j/njlauers/scm_tmpdir/press_video/press_cluster_pe${pe}_phi${phi}_eps${eps}_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 /pine/scr/n/j/njlauers/scm_tmpdir/complete_videos/press_pa${pe}_pb${pb}_xa${xa}_phi${phi}_eps${eps}_pNum${pNum}.mp4
