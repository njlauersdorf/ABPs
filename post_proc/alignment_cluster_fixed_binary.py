...
outPath='/pine/scr/n/j/njlauers/scm_tmpdir/binary_align/'#'Users/nicklauersdorf/hoomd-blue/build/04_01_20_parent/'#'/Volumes/External/04_01_20_parent/gsd/'
        ...
        if len(large_clust_ind_all[0])>0:
            ...
            for k in range(1,len(num_sights)):
                ...
                for h in range(0, len(rad_bin)):
                    ...
                    g.write('{0:.1f}'.format(rad_0_bin[h]).center(15) + ' ')
                    g.write('{0:.1f}'.format(rad_1_bin[h]).center(15) + ' ')
                    g.write('{0:.6f}'.format(num_dens[h]).center(15) + ' ')
                    g.write('{0:.6f}'.format(num_0_dens[h]).center(15) + ' ')
                    g.write('{0:.6f}'.format(num_1_dens[h]).center(15) + ' ')
                    g.write('{0:.6f}'.format(align_tot[h]).center(15) + ' ')
                    g.write('{0:.6f}'.format(align_0_tot[h]).center(15) + ' ')
                    g.write('{0:.6f}'.format(align_1_tot[h]).center(15) + '\n')
                g.close()
