...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 16 13:49:23 2020
...
txtFile = add + 'phase_density_pa' + str(peA) +\
          ...
          '_ep' + '{0:.3f}'.format(eps) +\
          '.txt'
f = open(gsdPath+txtFile, 'w') # write file headings
...
#                        dilutePhi = bins[g]
            ...
            plt.savefig(gsdPath+'look_distance' + str(lookDist[z]) +\
