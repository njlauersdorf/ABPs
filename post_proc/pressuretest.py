...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 19 11:12:00 2020
...
outPath='/pine/scr/n/j/njlauers/scm_tmpdir/surfacetens_Tom/'
...
with hoomd.open(name=inFile, mode='rb') as t:
    ...
    for j in range(start, end):
        ...
        print("Cluster radius: ", lEdge)
        print("Normalized surface tension: ", surfaceTense/l_box)
