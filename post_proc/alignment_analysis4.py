...
dens = os.listdir('../alignment_eps10_finish')
try:
...
all_dens = []
os.chdir(parent)
os.chdir('../alignment_eps10_finish')
for i in dens:
#     print(i)
                ...
                if num_dens[10]>1.0:
                    ...
                    if np.max(alpha_n_int_new)>=0.2:
                        ...
                        if begin_rad_point<end_rad_point:
                            ...
                            num_dens_very_orig_app = np.append(num_dens_very_orig, 0.0)
                            align_very_orig_app = np.append(align_very_orig, 0.0)
                            alpha_very_orig_app = np.append(alpha_very_orig, 0.0)
                            ...
                            alpha_n_int_rerenew2=alpha_n_int_renew(rad_renew3)
                            align_int_rerenew2=align_int_renew(rad_renew3)
                            num_dens_int_rerenew2=num_dens_int_renew(rad_renew3)
