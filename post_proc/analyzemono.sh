...
python3 $script_path/sim_frames_mono.py $fname $pa $pb $xa $ep $phi $tau
...
ffmpeg -start_number 0 -framerate 20 -i /Volumes/External/test_video_mono/cluster_pe${pa}_phi${phi}_eps${eps}_frame_%04d.png\
 -vcodec libx264 -s 1600x1200 -pix_fmt yuv420p -threads 1\
 /Volumes/External/test_video_mono/sim_frames_pa${pa}_pb${pb}_xa${xa}_phi${phi}_eps${eps}_pNum${pNum}.mp4
